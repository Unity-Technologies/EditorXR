...
public class HierarchyItem : ListViewItem<HierarchyData>
{
	...
	private void SelectRow(BaseHandle baseHandle, HandleEventData eventData)
	{
		selectRow(data);
	}
