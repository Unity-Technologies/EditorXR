...
namespace UnityEditor.Experimental.EditorVR.Tools
{
	sealed class BlinkVisuals : MonoBehaviour
	{
		...
		public bool outOfMaxRange
		{
			get { return Mathf.Abs(pointerStrength) > m_MaxArc; }
		}

		public Vector3 locatorPosition
		{
			get { return locatorRoot.position; }
		}

		public Transform locatorRoot
		{
			get { return m_LocatorRoot; }
		}
		...
		{
			get { return m_State == State.TransitioningIn || m_State == State.Active; }
		}

		private void OnDestroy()
		{
			ObjectUtils.Destroy(m_BlinkMaterial);
			ObjectUtils.Destroy(m_MotionSpheresMaterial);
		}
