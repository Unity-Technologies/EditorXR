...
namespace UnityEditor.Experimental.EditorVR.Core
{
    ...
    public class AffordanceAnimationDefinition
    {
        ...
        /// </summary>
        public AxisFlags translateAxes
        {
            get { return m_TranslateAxes; }
            set { m_TranslateAxes = value; }
        }

        /// <summary>
        /// The axes on which to perform rotation of an affordance
        /// </summary>
        public AxisFlags rotateAxes
        {
            get { return m_RotateAxes; }
            set { m_RotateAxes = value; }
        }
        ...
        /// </summary>
        public bool reverseForRightHand
        {
            get { return m_ReverseForRightHand; }
            set { m_ReverseForRightHand = value; }
        }
