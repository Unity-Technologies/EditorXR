...
namespace UnityEditor.Experimental.EditorVR.Helpers
{
    ...
    /// </summary>
    [Serializable]
    public class ContinuousDirectionalVelocityTracker
    {
        [SerializeField]
        ...
        float[] m_AngularUniformityChunks = new float[0];
        ...
        /// </summary>
        public float directionalDivergence { get; private set; }
        ...
        public void Initialize(Vector3 startPoint)
        {
            ...
            m_AngularUniformityChunks = new float[m_Steps];
        ...
        public void Update(Vector3 newPosition, float timeSlice)
        {
            ...
            var newAngularDivergence = Vector3.Dot(m_LastPosition, newPosition - m_LastPosition) * 10;

            m_LastPosition = newPosition;
            m_DistanceChunks[m_ChunkIndex] += newDistance;
            m_AngularUniformityChunks[m_ChunkIndex] += newAngularDivergence;
            m_Offsets[m_ChunkIndex] += currentOffset;

            // Update the average velocity
            var totalTime = 0.0f;
            var totalDistance = 0.0f;
            var totalAngularUniformity = 0.0f;
            ...
            while (chunkCounter < m_Steps)
            {
                if (chunkCounter == m_ChunkIndex)
                {
                    ...
                    totalAngularUniformity += m_AngularUniformityChunks[chunkCounter] * m_NewChunkWeight;
                ...
                else
                {
                    ...
                    totalAngularUniformity -= m_AngularUniformityChunks[chunkCounter];
