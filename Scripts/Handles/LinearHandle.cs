...
namespace UnityEngine.VR.Handles
{
	public class LinearHandle : BaseHandle
	{
		...
		{
			return new LinearHandleEventData(eventData.rayOrigin, U.Input.IsDirectEvent(eventData)) { raycastHitWorldPosition = eventData.pointerCurrentRaycast.worldPosition };
		}
