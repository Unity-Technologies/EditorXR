...
namespace UnityEditor.Experimental.EditorVR
{
	...
	public static class IInstantiateUIMethods
	{
		...
		/// <param name="connectInterfacesOverride">(Optional) RayOrigin override that will be used when connecting interfaces on this object
		/// such that the object keeps the same world space position, rotation and scale as before.</param>
		/// <returns></returns>
		public static GameObject InstantiateUI(this IInstantiateUI obj, GameObject prefab, Transform parent = null, bool worldPositionStays = true, Transform connectInterfacesOverride = null)
		{
			return instantiateUI(prefab, parent, worldPositionStays, connectInterfacesOverride);
		}
	}
}
#endif