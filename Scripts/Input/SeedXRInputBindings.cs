...
namespace UnityEditor.Experimental.EditorXR.LegacyInputHelpers
{
    ...
    public class SeedXRInputBindings
    {
        ...
        static public void UpdateInputManager()
        {
        ...
        internal bool ApplyDataToInputManager(List<InputAxis> inputManagerData, List<InputAxis> newData, Dictionary<string, BindingData> newDataMap, ref SerializedProperty arrayRoot)
        {
            var inputManagerModified = false;
            ...
            for (int i = 0; i < newData.Count; ++i)
            {
                ...
                inputManagerModified = true;
                arrayIndex++;
            }
            arrayRoot.arraySize = arrayIndex;

            return inputManagerModified;
        }
