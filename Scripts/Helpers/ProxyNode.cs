...
namespace UnityEditor.Experimental.EditorVR.Proxies
{
    ...
    class ProxyNode : MonoBehaviour, ISetTooltipVisibility, ISetHighlight, IConnectInterfaces
    {
        ...
        internal void AddShakeRequest()
        {
            RemoveFeedbackRequest(k_ShakeFeedbackRequest);
            AddFeedbackRequest(k_ShakeFeedbackRequest);
        }

        internal void AddFeedbackRequest(ProxyFeedbackRequest request)
        {
        ...
        internal void RemoveFeedbackRequest(ProxyFeedbackRequest request)
        {
            AffordanceData affordanceData;
            if (m_AffordanceData.TryGetValue(request.control, out affordanceData))
            {
        ...
        internal void ClearFeedbackRequests(IRequestFeedback caller)
        {
        ...
        internal SerializedFeedback OnSerializePreferences()
        {
            if (m_SerializedFeedback != null)
            {
        ...
        internal void OnDeserializePreferences(object obj)
        {
            if (obj == null)
                return;
