...
#pragma warning restore 649
        ...
        void Update()
        {
            ...
            m_ElevationText.text = string.Format("{0:F2} m", altitude);
            ...
            m_ElevationText.color = new Color(1f, 1f, 1f, m_IntensityCore);
