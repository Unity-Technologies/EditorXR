        ...
        */
        ...
        public void ProcessInput(ActionMapInput input, ConsumeControlDelegate consumeControl)
        {
            ...
            */
            ...
            if ( m_CurrentSpatialActionMapInput.showDirectionalTrigger.positive.isHeld ||
            ...
            if ((m_CurrentSpatialActionMapInput.showDirectionalTrigger.positive.isHeld || m_CurrentSpatialActionMapInput.show.isHeld) && m_SpatialMenuState != SpatialMenuState.hidden)
            {
...
*/
            ...
            if (!m_CurrentSpatialActionMapInput.showDirectionalTrigger.positive.isHeld && !m_CurrentSpatialActionMapInput.show.isHeld && !m_CurrentSpatialActionMapInput.select.isHeld)
            {
                visible = false;
                return;
            }
